...
function sapn_defaults() {
    return [
        ...
        // Results CTAs
        'result_book_label'      => 'Book My Sleep Consultation',
        'result_book_url'        => '',
        'result_insurance_label' => 'Ask About Insurance Coverage',
...
function sapn_settings_page() {
    ...
    <div class="wrap">
        <h1 style="display:flex;align-items:center;gap:12px;margin-bottom:8px;">
            ...
            <span>Sleep Apnea Estimator <span style="color:#94a3b8;font-weight:400;font-size:14px;">— by Adel Emad · <a href="https://upwork.com/freelancers/adelsherif8" target="_blank">upwork.com/freelancers/adelsherif8</a></span></span>
        </h1>
...
function sapn_render_settings_tab( $s ) {
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table" role="presentation">
            <tr><th><label>Book button text</label></th><td><input type="text" name="<?= SAPN_OPTION ?>[result_book_label]" value="<?= esc_attr( $s['result_book_label'] ) ?>" class="regular-text"/></td></tr>
            <tr><th><label>Book button URL</label></th><td><input type="url" name="<?= SAPN_OPTION ?>[result_book_url]" value="<?= esc_attr( $s['result_book_url'] ) ?>" class="regular-text" placeholder="https://example.com/book"/></td></tr>
            <tr><th><label>Insurance button text</label></th><td><input type="text" name="<?= SAPN_OPTION ?>[result_insurance_label]" value="<?= esc_attr( $s['result_insurance_label'] ) ?>" class="regular-text"/></td></tr>
            <tr><th><label>Insurance button URL</label></th><td><input type="url" name="<?= SAPN_OPTION ?>[result_insurance_url]" value="<?= esc_attr( $s['result_insurance_url'] ) ?>" class="regular-text" placeholder="https://example.com/insurance"/></td></tr>
        </table>
